    ...
    public class Adm_ReportsController : Controller
    {
        ...
        public ActionResult Index(OrderSearchModel appSearch)
        {
            ...
            if (appSearch != null)
            {
                ...
                if (appSearch.Store != null && appSearch.Store != "")
                   // result = result.Where(x => x.OrderDetails..Name.Contains(appSearch.Customer) || x.Customer.Name.StartsWith(appSearch.Customer));
